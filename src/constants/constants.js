...
export const TimeLineData = [
  ...
  { year: 2019, text: 'Completed the Full Stack Web Dev Boot Camp', },
  { year: 2020, text: 'Built projects to hone in skills', },
  { year: 2021, text: 'Life happened and a detour had to be taken', },
  { year: 2022, text: 'Returned to Web Dev with a PURPOSE, started freelancing business', },
];